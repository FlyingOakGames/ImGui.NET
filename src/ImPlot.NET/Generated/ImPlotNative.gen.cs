...
namespace ImPlotNET
{
    public static unsafe partial class ImPlotNative
    {
        ...
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ImPlot_ColormapScale(byte* label, double scale_min, double scale_max, Vector2 size, ImPlotColormap cmap);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram_FloatPtr(byte* label_id, float* values, int count, ImPlotBin bins, byte cumulative, byte density, ImPlotRange range, byte outliers, double bar_scale);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram_doublePtr(byte* label_id, double* values, int count, ImPlotBin bins, byte cumulative, byte density, ImPlotRange range, byte outliers, double bar_scale);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram_S8Ptr(byte* label_id, sbyte* values, int count, ImPlotBin bins, byte cumulative, byte density, ImPlotRange range, byte outliers, double bar_scale);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram_U8Ptr(byte* label_id, byte* values, int count, ImPlotBin bins, byte cumulative, byte density, ImPlotRange range, byte outliers, double bar_scale);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram_S16Ptr(byte* label_id, short* values, int count, ImPlotBin bins, byte cumulative, byte density, ImPlotRange range, byte outliers, double bar_scale);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram_U16Ptr(byte* label_id, ushort* values, int count, ImPlotBin bins, byte cumulative, byte density, ImPlotRange range, byte outliers, double bar_scale);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram_S32Ptr(byte* label_id, int* values, int count, ImPlotBin bins, byte cumulative, byte density, ImPlotRange range, byte outliers, double bar_scale);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram_U32Ptr(byte* label_id, uint* values, int count, ImPlotBin bins, byte cumulative, byte density, ImPlotRange range, byte outliers, double bar_scale);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram_S64Ptr(byte* label_id, long* values, int count, ImPlotBin bins, byte cumulative, byte density, ImPlotRange range, byte outliers, double bar_scale);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram_U64Ptr(byte* label_id, ulong* values, int count, ImPlotBin bins, byte cumulative, byte density, ImPlotRange range, byte outliers, double bar_scale);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram2D_FloatPtr(byte* label_id, float* xs, float* ys, int count, ImPlotBin x_bins, ImPlotBin y_bins, byte density, ImPlotLimits range, byte outliers);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram2D_doublePtr(byte* label_id, double* xs, double* ys, int count, ImPlotBin x_bins, ImPlotBin y_bins, byte density, ImPlotLimits range, byte outliers);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram2D_S8Ptr(byte* label_id, sbyte* xs, sbyte* ys, int count, ImPlotBin x_bins, ImPlotBin y_bins, byte density, ImPlotLimits range, byte outliers);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram2D_U8Ptr(byte* label_id, byte* xs, byte* ys, int count, ImPlotBin x_bins, ImPlotBin y_bins, byte density, ImPlotLimits range, byte outliers);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram2D_S16Ptr(byte* label_id, short* xs, short* ys, int count, ImPlotBin x_bins, ImPlotBin y_bins, byte density, ImPlotLimits range, byte outliers);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram2D_U16Ptr(byte* label_id, ushort* xs, ushort* ys, int count, ImPlotBin x_bins, ImPlotBin y_bins, byte density, ImPlotLimits range, byte outliers);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram2D_S32Ptr(byte* label_id, int* xs, int* ys, int count, ImPlotBin x_bins, ImPlotBin y_bins, byte density, ImPlotLimits range, byte outliers);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram2D_U32Ptr(byte* label_id, uint* xs, uint* ys, int count, ImPlotBin x_bins, ImPlotBin y_bins, byte density, ImPlotLimits range, byte outliers);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram2D_S64Ptr(byte* label_id, long* xs, long* ys, int count, ImPlotBin x_bins, ImPlotBin y_bins, byte density, ImPlotLimits range, byte outliers);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern double ImPlot_PlotHistogram2D_U64Ptr(byte* label_id, ulong* xs, ulong* ys, int count, ImPlotBin x_bins, ImPlotBin y_bins, byte density, ImPlotLimits range, byte outliers);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
